...
var WeatherSuccess2 = message.New(`Wow it works!!! It's '%s outside and temperature %3.1f degrees`,
	`Урааа, оно работает!!! За окошком %s и температура %3.1f градусов`)
var WeatherSuccess3 = message.New(`Ha-ha not bad for me. My third eye says it's %s outside. Wait wait... Temperature  %3.1f degrees Celsius`,
	`Ха-ха, совсем неплохо. Мой третий глаз подсказывает мне, что у тебя %s за окошком. Погоди погоди... Температура %3.1f градусов по Цельсию`)
