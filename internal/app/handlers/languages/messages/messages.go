...
var InitConversation1 = message.New("Henlo %s... I'm the diviner pug."+
	...
	"try to do some street magic? But I need your help. Tap the button when you will be ready. And one more thing. You always can ask me question. Just write '?' sign in the end of your message",
	`Примвет %s... Я мопс-предсказатель. Я забыл все кроме своего имени... Я не могу вспомнить что случилось со мной, но я пытаюсь... Я забыл как предсказывать... Ой, смотри, там свиток древних со всякими магическими приколами. Хмммм, может я смогу попробовать что то скастовать? Но мне нужна твоя помощь. Нажми на кнопку как будешь готов. Ой и еще. Ты всегда можешь спросить у меня что то, просто напиши в конце своего сообщения знак '?'`)
